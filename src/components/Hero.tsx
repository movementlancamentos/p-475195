      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10" ref={containerRef}>
        <div className="flex flex-col items-start max-w-4xl">
          <div className="w-full">
            ...
            <h1 
              className="section-title text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight opacity-0 animate-fade-in font-bold tracking-tight" 
              style={{ animationDelay: "0.3s" }}
            >
              MENTORIA IA PARA<br className="hidden sm:inline" />
              LANÇAMENTOS
            </h1>
            
            <h2 
              style={{ animationDelay: "0.5s" }} 
              className="mt-6 mb-4 leading-relaxed opacity-0 animate-fade-in text-gray-200 font-semibold text-lg sm:text-xl lg:text-2xl text-left max-w-4xl"
            >
              O Sistema Completo Para Você Criar um Exército de IAs Que Fazem o Trabalho de +10 Pessoas, Vendem 24/7 e Te Dão a Liberdade Que Você Perdeu Quando Virou Lançador.
            </h2>

            <p 
              style={{ animationDelay: "0.7s" }} 
              className="mb-6 sm:mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-300 font-medium text-base sm:text-lg text-left max-w-3xl"
            >
              Mesmo Se Você Não Entende Nada de Tecnologia, Está Sobrecarregado e Acha Que IA É Complicada Demais.
            </p>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-4 mt-8 sm:mt-12 opacity-0 animate-fade-in max-w-lg" style={{ animationDelay: "1.1s" }}>
