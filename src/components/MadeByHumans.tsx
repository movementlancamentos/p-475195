...
const MadeByHumans = () => {
  return (
    <section id="made-by-humans" className="w-full bg-black py-0">
        ...
        <div className="w-full rounded-2xl sm:rounded-3xl overflow-hidden relative mt-6 sm:mt-8">
          <div className="bg-no-repeat bg-cover bg-center p-4 sm:p-5 min-h-[250px] sm:min-h-[350px] flex flex-col justify-between" style={{
            ...
            <div className="flex items-center text-white">
              <img src="/logo.svg" alt="Mentoria IA Logo" className="h-5 sm:h-6 w-auto mr-3 invert" />
              <span className="text-white text-xl font-medium">Mentoria IA</span>
            </div>
            ...
            {/* Black box at the bottom with overflow */}
